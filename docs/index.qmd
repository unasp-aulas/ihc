...
## ENIAC {background-image="images/eniac-today.gif" background-position="450% 50%" background-size="90%"}

:::: columns
::: {.column width=40%}
- Tamanho e peso: Ocupando uma sala inteira e pesando 30 toneladas. 
- Capacidade de processamento: Embora enorme, sua capacidade de processamento era inferior à de calculadoras modernas, capaz de realizar cerca de 5.000 adições por segundo. 
- Programação: O sistema operacional era operado por um grupo de funcionárias do exército, consideradas as primeiras programadoras. 
:::
::::
...
## Um breve histórico <br> da IHC {background-image="images/alto.png" background-position="100% 80%" background-size="45%"}
...
- [Ergonomia Física]{.blue}: referente às características humanas anatômicas, antropométricas, fisiológicas e biomecânicas, e como estas se relacionam com a atividade física. Tópicos importantes incluem posturas de trabalho, levantamento de material, movimentos repetitivos, distúrbios musculoesquelético relacionados ao trabalho, layout do local de trabalho, segurança e saúde.
- [Ergonomia Cognitiva]{.blue}: referente aos processos mentais: percepção, memória, raciocínio e respostas motoras. Estuda também como esses processos afetam as interações entre pessoas e outros elementos do sistema. Tópicos relevantes são a carga de trabalho mental, tomada de decisão, interação homem-computador, estresse e treinamento de trabalho da maneira que possam se relacionar com o projeto humanosistema.
...
- [Eficiência:]{.blue} as pessoas podem realizar ações mediante uma quantidade adequada de esforço. 
- [Eficácia:]{.blue} o sistema realiza funções a que se destina com informações adequadas e organizadas apropriadamente. 
- [Fácil de aprender:]{.blue} é possivel aprender como realizar as ações e lembrar como repeti-las após algum tempo. 
- [Segurança:]{.blue} o sistema é seguro de operar na variedade de contextos em que será usado. 
- [Utilidade:]{.blue} o sistema realiza aquilo que as pessoas querem que seja feito.

## Usabilidade centrado no humano

\

*Assim como o objetivo da ergonomia é focar o humano, o mesmo ocorre com a [usabilidade]{.blue}.* Para alcançar a usabilidade adequada, o desenvolvimento de um sistema deve ser [centrado no humano]{.mark}, já que são pessoas que vão utilizá-lo e que podem depender dele para conseguir realizar as ações que desejam. [Porém, enquanto a ergonomia foca o trabalho e o conforto fisico/mental do usuário, a usabilidade lida com interfaces e a satisfação de quem vai utilizá-las.]{.mark}
...
![Wireframe de baixa fidelidade](images/wireframe.png){width=60%}
</center>
:::
::::
...
### Projeto conceitual ^[<https://irlabr.wordpress.com/apostila-de-ihc/modelos-conceituais/>]
...
- [Metáfora:]{.blue} referência de uma mesa de trabalho e seus elementos relacionados, como documentos, pastas e lixeiras;
- [WYSIWYG (what you see is what you get):]{.blue} os usuários manipulam objetos diretamente na interface a exemplo dos documentos e  pastas.
- [Consistência de comandos:]{.blue} os conceitos de ações aplicados ao sistema e aos objetos são preservados e as semelhanças de execução entre comandos é mantida sempre que possível (copiar, selecionar, colar, mover ou excluir possuem sempre a mesma forma de realização da tarefa).
...
## Diferenças entre wireframe, mockup e prototipagem

\

<center>
![](images/wire-mock-proto.png){width=80%}
</center>
...
> Como os usuários criam modelos mentais? Eles usam o que já sabem do mundo. Segundo a lei de Jakob, usuários passam mais tempo em outros sites do que no seu. Por isso, esperam que seu site funcione como os outros.^[<https://www.nngroup.com/articles/mental-models/>]

:::
::: {.column}
<center>
![](images/mental-models.jpg){width=70%}
</center>
:::
:::
...
> "Um modelo estrutural é aquele em que se assume que o usuário internalizou a estrutura de funcionamento do dispositivo ou sistema na memória, enquanto um modelo funcional assume que o usuário internalizou o conhecimento procedural sobre como usar o dispositivo ou sistema." ^[<https://www-users.york.ac.uk/~adh2/Ch2.pdf>]
...
## Nível AAA: Ainda mais acessível
